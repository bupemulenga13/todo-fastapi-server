...
def get_pmtc_eid_pos_2_12(engine: Engine, start_date: str, end_date: str) -> Optional[List[dict]]:
	"""
    Returns a list of pmtc_eid_pos_2_12 data
	...
	AND DATEDIFF(MONTH, rg.DateOfBirth, @EndDate) BETWEEN 2 and 13

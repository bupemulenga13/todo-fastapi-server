...
def get_hts_positive(engine: Engine, start_date: str, end_date: str) -> Optional[List[dict]]:
	"""
    Returns a list of hts positive data
	...
	select Nupin,
			...
			EntryPoint
	from #staging 
	WHERE #staging.HIVResult = 'Positive' AND #staging.EntryPoint IS NOT NULL
	order by Nupin 

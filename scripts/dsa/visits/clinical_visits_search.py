...
def get_clinical_visits_search_list(engine: Engine, start_date: str, end_date: str, patient_id: str) -> Optional[List[dict]]:
    """
    Returns a list of clinical visits that match search criteria.
...
Join Login l on CAST(l.LoginID AS VARCHAR(10)) =  cast((b.InteractionUser) as VARCHAR(10))
  ...
  and reg.PatientId LIKE '%{patient_id}%'

...
def get_visit_types_list(engine: Engine, start_date: str, end_date: str) -> Optional[List[dict]]:
    """
    Returns a list of visit types.
    ...
    and servicex.ServiceCode in (3,24,25,27,28,29,30,33,38,39,44,47,48,50,53,54,55,59,315,330,328,339,333,329,359,350,353,352,337,317,344,347,327,600,610,354,355,356,357)

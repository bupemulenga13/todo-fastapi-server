...
def get_testing_search_list(engine: Engine, start_date: str, end_date: str, art_number: str) -> Optional[List[dict]]:
    """
    Returns a list of testing data that match search criteria.
    ...
    select Nupin,
            ...
            from #staging 
            WHERE ARTNumber LIKE '%{art_number}%'
    order by Nupin 
    """)

...
def get_pharm_picks_count(engine: Engine, start_date: str, end_date: str) -> Optional[List[dict]]:
    """
    Returns a count of pharm picks for the given date range.
  ...
  select SurName + ', ' + FirstName                         'ClientName',
         PhoneNumber                                        'PhoneNumber',
         MobilePhoneNumber                                  'MobilePhoneNumber',
         PObox + ', ' + HousePlotNumber + ', ' + StreetName 'Address',
         ArtID                                              'ArtNumber',
         LastPharmacyVisit                                  'LastPharmacyVisit',
         NextPharmacyVisit                                  'NextPharmacyVisit',
         DaysLatePharmacy                                   'DaysLate',
         OnARVs                                             'OnARVs',
         LastCD4Count                                       'LastCD4Count',
         DueForViralLoad                                    'DueForVL',
         ScheduledViralLoadTestDate                         'ScheduledTestDate',

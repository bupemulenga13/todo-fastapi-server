...
def get_appointments_search_list(engine: Engine, start_date: str, end_date: str, art_number: str) -> Optional[List[dict]]:
    """
    Returns a list of appointments that match search criteria.

...
def get_morbidity_list(engine: Engine, start_date: str, end_date: str) -> Optional[List[dict]]:
    """
    Returns a list of all morbidity data.
    ...
    IF object_id('tempdb..#HmisCodes') is not null
        ...
        Convert(varchar, d.VisitDate, 103)                              as 'DateOfRegistration',
        Convert(varchar, d.DateOfDeath, 103) as DateOfDeath,
        d.AgeOfDeceased,
        ...
        (select ISNULL(@LoginName, 'Unknown'))                       as LoginName,

...
def get_labs_search_list(engine: Engine, start_date: str, end_date: str, patient_id: str) -> Optional[List[dict]]:
    """
    Returns a list of labs that match search criteria.
    ...
    (
        SELECT
          ...
          WHERE (d.Deprecated <> 1 OR d.Deprecated is null) AND registration.PatientID LIKE '{patient_id}'

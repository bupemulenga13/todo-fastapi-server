...
from scripts.dsa.referals import *


def get_referals(db: Session, req_start_date: str, req_end_date: str ) -> Optional[List[dict]]:
    try:
        sql_query = get_referals_list(db, req_start_date or start_date, req_end_date or end_date)
